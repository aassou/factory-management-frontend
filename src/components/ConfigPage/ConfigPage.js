...
const ConfigPage = () => {
  const configlinks = [
    {
      name: 'Sociétés', link: '/configuration/companies', color: 'blue-card', icon: 'fa fa-sitemap', description: 'Gestion des informations juridiques de la société.',
    },
    {
      name: 'Utilisateurs', link: '/configuration/users', color: 'darkblue-card', icon: 'fa fa-user', description: 'Gestion des comptes des utilisateurs du system.',
    },
    {
    ...
    {
      name: 'Archive Paiement', link: '/configuration/archive-paiement', color: 'orange-two-card', icon: 'fa fa-archive', description: 'Archive des paiements des clients.',
    },
    {
